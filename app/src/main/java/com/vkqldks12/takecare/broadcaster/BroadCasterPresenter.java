...
import com.vkqldks12.takecare.Rtc_Peer.kurento.KurentoPresenterRTCClient;
import com.vkqldks12.takecare.Rtc_Peer.kurento.models.CandidateModel;
import com.vkqldks12.takecare.Rtc_Peer.kurento.models.response.ServerResponse;
import com.vkqldks12.takecare.Rtc_Peer.kurento.models.response.TypeResponse;
import com.vkqldks12.takecare.Util.RxScheduler;
...
public class BroadCasterPresenter extends MvpBasePresenter<BroadCasterView>
    ...
    public void sendUserInfo(String userName, String userEmail){
        rtcClient.setInfo(userName,userEmail);
    }
